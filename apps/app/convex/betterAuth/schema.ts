...
export const tables = {
  ...
  organization: defineTable({
    ...
    customDomain: v.optional(v.union(v.null(), v.string())),
    domainVerifiedAt: v.optional(v.union(v.null(), v.number())),
    domainVerificationStatus: v.optional(v.union(v.null(), v.string())),
  })
    .index("name", ["name"])
    .index("slug", ["slug"])
