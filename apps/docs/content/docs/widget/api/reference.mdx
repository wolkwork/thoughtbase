...
```javascript
window.feedbackWidget.identify('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...');
```
...
When `initFeedbackWidget` is called:
...
For additional help:
- Check the [Getting Started Guide](/docs/widget/guides/getting-started)
- Review the [SSO Integration Guide](/docs/widget/guides/sso-integration)
